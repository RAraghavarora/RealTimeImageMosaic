...
p = '/Users/davinderkumar/Essentials/LOP/Codes/images/input'
...
def surf(image1, image2):
    ...
    kp2, des2 = surf.detectAndCompute(image1, None)
    return kp1, des1, kp2, des2
...
#     print(_)
#     print("Time = ", time.time() - t1)  
#     x = cv2.imwrite(str(_) + "surf_output.jpg", trim(dst)) 
#     print(x)
